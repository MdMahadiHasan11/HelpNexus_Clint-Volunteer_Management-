...
const AddNeedVolunteer = () => {
    ...
    return (
        <div hero className="min-h-screen hero-overlay bg-opacity-60" style={{ backgroundImage: 'url(https://i.ibb.co/QcB8N5Z/618fa90c201104b94458e1fb-64d4c62ef4a375d9ba140a1e-Behind-the-Scenes-of-High-Performing-React-Apps-An.jpg)' }}>

            {/* title */}
            <div className='mt-10'>
                <p data-aos="fade-down"
                    data-aos-easing="ease-out-cubic"
                    data-aos-duration="1000" className="text-3xl font-bold  text-center bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 py-8 mt-6 mb-2 text-white"><Fade>Add Volunteer Post</Fade> 
                </p>
            </div>


            <div className='flex pb-10 justify-center items-center min-h-[calc(100vh-306px)] w-full my-12'>
                ...
                <section className=' p-2 md:p-6 mx-auto bg-white rounded-md shadow-2xl '>
                    ...
                    <form onSubmit={handleAdd} className="mx-auto">
                        ...
                        <div className="form-control mt-6">
                            <button className="btn btn-primary font-bold">Add Post</button>
                        </div>
                    </form>
                    <div>
